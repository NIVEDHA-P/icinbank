	...
	public static void main(String[] args) {
		...
		driver.navigate().to("http://localhost:8009/index");
		 driver.findElement(By.name("username")).sendKeys("nivi");
		  ...
		  driver.findElement(By.xpath("/html/body/div[2]/div[2]/div[2]/div/a/div/span[1]")).click();
		 ...
		 driver.findElement(By.xpath("/html/body/div[2]/div[2]/div[1]/div[1]/a/div/span[1]")).click();
	}
